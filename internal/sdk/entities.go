...
import (
	...
	"context"
	"fmt"
	"github.com/epilot-dev/terraform-provider-epilot-saved-view/internal/sdk/internal/hooks"
	"github.com/epilot-dev/terraform-provider-epilot-saved-view/internal/sdk/internal/utils"
	"github.com/epilot-dev/terraform-provider-epilot-saved-view/internal/sdk/models/errors"
	...
	"github.com/epilot-dev/terraform-provider-epilot-saved-view/internal/sdk/retry"
	"net/http"
	"net/url"
)
...
func (s *Entities) CreateEntity(ctx context.Context, request operations.CreateEntityRequest, opts ...operations.Option) (*operations.CreateEntityResponse, error) {
	...
	case httpRes.StatusCode == 422:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EntityValidationV2ResultError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.EntityValidationV2ResultError = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Entities) GetEntity(ctx context.Context, request operations.GetEntityRequest, opts ...operations.Option) (*operations.GetEntityResponse, error) {
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetEntityEntitiesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Entities) GetEntityV2(ctx context.Context, request operations.GetEntityV2Request, opts ...operations.Option) (*operations.GetEntityV2Response, error) {
	...
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetEntityV2ResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Entities) ReindexEntity(ctx context.Context, request operations.ReindexEntityRequest, opts ...operations.Option) (*operations.ReindexEntityResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/entity/{slug}/{id}:reindex", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ReindexEntityResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// Validates an entity against the schema.
func (s *Entities) ValidateEntityV2(ctx context.Context, request operations.ValidateEntityV2Request, opts ...operations.Option) (*operations.ValidateEntityV2Response, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/entity/{slug}:validate", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ValidateEntityV2Response{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.EntityValidationV2ResultSuccess
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.EntityValidationV2ResultSuccess = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
